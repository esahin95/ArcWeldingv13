...
namespace solvers
{
    defineTypeNameAndDebug(incompressibleReactingVoF, 0);
    addToRunTimeSelectionTable(solver, incompressibleReactingVoF, fvMesh);
}
}
...
Foam::solvers::incompressibleReactingVoF::incompressibleReactingVoF(fvMesh& mesh)
:
...
Foam::solvers::incompressibleReactingVoF::~incompressibleReactingVoF()
{}


// * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * * //

void Foam::solvers::incompressibleReactingVoF::prePredictor()
{
