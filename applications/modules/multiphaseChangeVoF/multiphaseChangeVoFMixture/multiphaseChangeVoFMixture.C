...
#include "multiphaseChangeVoFMixture.H"
...
namespace Foam
{
    defineTypeNameAndDebug(multiphaseChangeVoFMixture, 0);
}


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::multiphaseChangeVoFMixture::multiphaseChangeVoFMixture
(
    const fvMesh& mesh
)
:
    ...
    multiphaseVoFMixture(mesh, phaseChangeVoFphase::iNew(mesh, T())),

    phases_(multiphaseVoFMixture::phases().convert<phaseChangeVoFphase>()),
...
bool Foam::multiphaseChangeVoFMixture::incompressible() const
{
...
Foam::multiphaseChangeVoFMixture::psiByRho() const
{
...
Foam::tmp<Foam::volScalarField> Foam::multiphaseChangeVoFMixture::alphaEff
(
...
Foam::tmp<Foam::volScalarField>
Foam::multiphaseChangeVoFMixture::rCv() const
{
...
void Foam::multiphaseChangeVoFMixture::correctThermo()
{
    forAll(phases_, phasei)
    {
...
void Foam::multiphaseChangeVoFMixture::correct()
{
...
void Foam::multiphaseChangeVoFMixture::correctRho
(
