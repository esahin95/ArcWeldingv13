...
Foam::fv::traceSurface::traceSurface
(
...
Foam::wordList Foam::fv::traceSurface::addSupFields() const
{
...
void Foam::fv::traceSurface::correct()
{
...
void Foam::fv::traceSurface::addSup
(
...
void Foam::fv::traceSurface::topoChange(const polyTopoChangeMap& map)
{}


void Foam::fv::traceSurface::mapMesh(const polyMeshMap& map)
{}


void Foam::fv::traceSurface::distribute(const polyDistributionMap& map)
{}


bool Foam::fv::traceSurface::movePoints()
{
    return true;
}

bool Foam::fv::traceSurface::write(const bool write) const
 {
    if (Pstream::parRun())
    {
