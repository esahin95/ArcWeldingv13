...
#include "interfaceThermoProperties.H"
...
void Foam::interfaceThermoProperties::correctContactAngle
(
...
void Foam::interfaceThermoProperties::calculateK()
{
    const fvMesh& mesh = alpha1_.mesh();
...
Foam::interfaceThermoProperties::interfaceThermoProperties
(
...
Foam::tmp<Foam::volVectorField> Foam::interfaceThermoProperties::n() const
{
...
Foam::interfaceThermoProperties::sigmaK() const
{
...
Foam::tmp<Foam::volScalarField>
Foam::interfaceThermoProperties::nearInterface() const
{
...
bool Foam::interfaceThermoProperties::read()
{
